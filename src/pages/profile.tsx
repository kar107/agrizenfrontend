  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <motion.div
        ...
        className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full border border-gray-200"
      >
        ...
        {isEditing ? (
          <>
            ...
            />
            <button
              className="mt-5 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg w-full transition-all"
        ...
        {isChangingPassword ? (
          ...
          <button
            className="mt-5 bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-lg w-full transition-all"
